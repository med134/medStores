...
export default function CartPage() {
  ...
  return (
    <AnimatePage> 
    <section className="h-full w-full bg-gray-100 py-12 sm:py-16 lg:py-20 font-['Roboto']">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-center">
          <h1 className="text-center text-2xl text-[#4466f2] font-['Pacifico']">
            {t("yourCart")}
          </h1>
        </div>
            ...
            {totalPrice > 0 ? (
              <div className="px-4 py-6 sm:px-8 sm:py-10">
                ...
                <div className="mt-6 text-center">
                  ...
                  <button onClick={()=>navigate('/')} className="text-blue-500 p-3 inline-flex underline font-semibold"><BsArrowLeftShort className="text-blue-500 text-3xl"/>
